...
class SinglyLinkedList:
    """
    It contains nodes for a singly linked list and methods for ->
    insertion
    """
    def __init__(self):
        """
        The initialization is called when instance of class created
        """
        self.__head = None

    def __str__(self):
        """
        It is used by print to print linked list
        """
        tmp = self.__head
        string = ""
    ...
    def sorted_insert(self, value):
        """
        It inserts a new Node into the correct sorted position
                                            (based on data)
        """
        tmp = self.__head
        if tmp is None:
