#!/usr/bin/python3
"""Python - Almost a circle, for task 2 - 13"""
from models.base import Base


class Rectangle(Base):
    """It creates rectangle objects with 2 dimensions and offset coordinates.
    ...
    def __integer_validator(self, attr, value):
        """It validates incoming argument values for use with internal
        attributes.
    ...
    def area(self):
        """It returns area of rectangle as product of `width` and `height`.
    ...
    def display(self):
        """It prints representation of rectangle to stdout using '#'.
    ...
    def __str__(self):
        """It returns string with numeric representation of rectangle
    ...
    def update(self, *args, **kwargs):
        """It updates attributes in a given order based on variable amount of
    ...
    def to_dictionary(self):
        """It creates dictionary representation of self without revealing
        private attribute names, as would __dict__.
