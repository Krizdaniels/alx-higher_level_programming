...
class Base:
    """It assigns `id` and manages related attributes across all instances.
    ...
    # The attribute assigment here engages setters defined below
    ...
    def to_json_string(list_dictionaries):
        """It converts list of dictionaries into JSON string.
    ...
    def save_to_file(cls, list_objs):
        """It saves to file a JSON formatted string of a list of dictionary
    ...
    def from_json_string(json_string):
        """It returns list of objects represented by JSON format string,
    ...
    def create(cls, **dictionary):
        """it creates a new dummy instance of class and `update()`s it using
    ...
    def load_from_file(cls):
        """it returns list of instances from file <class name>.json,
        or empty list
    ...
    def save_to_file_csv(cls, list_objs):
        """it saves to file a CSV formatted string of a list of dictionary
        representations of objects of `Base` derived classes.
    ...
    def load_from_file_csv(cls):
        """it returns list of instances from file <class name>.csv,
        or empty list
        if no file. `cls` determines class of instances.
