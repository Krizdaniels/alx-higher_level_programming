#!/usr/bin/python3
"""Python - Almost a circle, for task 10 - 14"""
from models.rectangle import Rectangle
from models.base import Base


class Square(Rectangle):
    """it creates square objects with 2 dimensions and offset coordinates.
    ...
    def __str__(self):
        """It returns string with numeric representation of square
    ...
    @property
    def size(self):
        """The `size` getter, but in this case `size` acts as alias for
        `width`/`height`.
    ...
    def update(self, *args, **kwargs):
        """It updates superclass attributes in a given order based on variable
