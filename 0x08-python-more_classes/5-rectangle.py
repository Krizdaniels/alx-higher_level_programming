#!/usr/bin/python3
"""It is built for Alx Python project 0x08 Python task 5.
"""


class Rectangle:
    """It akes in args for width and height of a rectangle, and contains
    methods for calculation of the area or perimeter.
