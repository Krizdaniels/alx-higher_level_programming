#!/usr/bin/python3
"""Python - Input/Output, for task 13. Student to disk and reload"""


class Student:
    """the imple class containing student data.
    ...
    def to_json(self, attrs=None):
        """It retrieves a dictionary representation of self, minus any
        elements whose keys are are not listed in `attrs`. If `attrs` is not
        a list of strings, returns entire dict of self.
    ...
    def reload_from_json(self, json):
        """It updates all attributes of self with values from dict
        in json file.
