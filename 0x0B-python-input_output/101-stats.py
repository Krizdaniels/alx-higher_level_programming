#!/usr/bin/python3
"""
Python - Input/Output, for task 14. Log parsing

It parses a log of HTTP GET request results from stdin to tabulate the total
...
def print_log_totals(total_file_size, code_counts):
    """
    it prints current totals of file size and status code counts.
